namespace Store_Dutta_Kaur
{
    ...
    {
        #region Array Storage and constants -@Pratiksha
        // Array to store employees -@Pratiksha
        static Employee[] employee = new Employee[1];
        // Array to hold employees -@Pratiksha
        static Client[] client = new Client[1];
        ...
        #region Initialize default data -@Pratiksha
        static void initializeDefaultData()
        {
            // Initialize default employee -@Pratiksha
            employee[0] = new Employee(defaultEmployeeId, defaultEmployeePasswor d);
        ...
        #region Menu Displays -@Pratiksha
        ...
        **/
        ...
        static void startProgram()
        {
            ...
            if (choiceMainMenu == 1)
            {
                ...
                if (roleChoice == 1)
                {
                    // display employee and functions -@Pratiksha
                }
